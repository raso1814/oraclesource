...
INSERT INTO VM_EMPALL VALUES(6666,'KIM','MANAGER',
NULL,'20/10/05',2650,NULL,20);

SELECT*FROM EMP;

--뷰 생성(수정 불가)
CREATE VIEW VM_EMP30READ AS SELECT EMPNO,ENAME FROM EMP 
...
MAXVALUE 90 
MINVALUE 0 --옵션
NOCYCLE CACHE 2; --옵션 CYCLE OR NOCYCLE, CACHE는 미리 발급해놓을 수

--DEPT 테이블에서 부서번호를 10으로 싲가해서 90까지 넣곳 싶을때
...
SELECT EMPNO, ENAME, JOB, DEPTNO,SAL, COMM FROM EMPIDX
WHERE SAL >= 1500;
...
LOGIN_PWE VARCHAR2(20) NOT NULL,
TEL VARCHAR2(20));

INSERT INTO TABLE_NOTNULL VALUES('TEST_01',NULL,'010-1234-5678');

INSERT INTO TABLE_NOTNULL(LOGIN_ID, LOGIN_PW E) VALUES('TEST_01','TEST_01');

-- CHECK : 열에 저장할 수 있는 값의 범위 또는 패턴 정의

--기본값을 지정 DEFAULT 
--특정 열에 저장할 값이 저장되지 않았을 경우에 입력되는 기본값

CREATE TABLE TABLE_DEFAULT(
LOGIN_ID VARCHAR2(20) CONSTRAINT TBLDF_LGNID_PI PRIMARY KEY,
...
VALUES('TEST_ID3',NULL,'010-1234-5678');
